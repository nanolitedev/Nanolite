...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QString::fromUtf8("0 NL"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0 NL"));
        ...
        labelImmature->setText(QString::fromUtf8("0 NL"));
        ...
        Wallet_logo = new QLabel(OverviewPage);
        Wallet_logo->setObjectName(QString::fromUtf8("Wallet_logo"));
        Wallet_logo->setPixmap(QPixmap(QString::fromUtf8(":/images/wallet_logo")));
        Wallet_logo->setAlignment(Qt::AlignCenter);

        verticalLayout_2->addWidget(Wallet_logo);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Nanolite network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        Wallet_logo->setText(QString());
        label_4->setText(QApplication::translate("OverviewPage", "<b>Recent transactions</b>", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Nanolite network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
